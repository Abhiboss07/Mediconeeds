...
export const COLUMNS = [
  ...
  { key: "price", header: "Price", aliases: ["price", "sellingprice", "selling price", "sale price"], required: true },
  { key: "mrp", header: "MRP", aliases: ["mrp", "maximumretailprice", "compare at price", "compareprice"] },
  { key: "stock", header: "Stock", aliases: ["stock", "qty", "quantity", "inventory"] },
  { key: "gst", header: "GST", aliases: ["gst", "gst%", "tax", "taxrate", "gst rate"] },
  { key: "weight", header: "Weight", aliases: ["weight", "netweight", "net weight"] },
  ...
  { key: "howToUse", header: "How To Use", aliases: ["howtouse", "how to use", "usage", "directions"] },
...
export function resolveHeader(header) {
  return ALIAS_MAP[norm(header)] || null;
}
