...
export const CANONICAL_CATEGORIES = [
  ...
  "Supplements",
  "Surgical Supplies",
  // Storefront "Shop by Category" taxonomy — so a real Dr Awish catalogue imports
  // with zero "unknown category" warnings.
  "Face Cream", "Acne Care", "Anti-Ageing", "Pigmentation", "Lip Care",
  "Under Eye", "Combos & Kits", "Skincare",
  // Legacy seller taxonomy — kept so older data / pickers still resolve.
  "Surgical", "Diagnostic", "Hospital Furniture", "Dermatology",
  "Devices", "Consumables", "Laboratory", "Dental",
];
