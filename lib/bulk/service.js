...
import { sanitizeText } from "@/lib/products/rules";

// Strip HTML/markup (XSS defense for non-escaping sinks) then neutralize any
// CSV-formula trigger, and cap length.
const clean = (v) => deFormula(sanitizeText(v, 5000)).slice(0, 5000);
