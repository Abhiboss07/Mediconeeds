...
// Best Sellers — ranked by popularity (reviews × rating), highest first.
export const getBestsellers = (n) =>
  [...products]
    .sort((a, b) => b.reviews * b.rating - a.reviews * a.rating)
    .slice(0, n || products.length);
// Offers — only discounted products, biggest discount first.
export const getOffers = (n) =>
  products
