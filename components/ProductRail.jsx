...
function Card({ p }) {
  ...
  return (
    <a href={`/products/${p.slug}`} className="shrink-0 w-[168px] lg:w-[184px] bg-white rounded-[10px] border border-[rgba(111,115,132,0.16)] hover:border-[#c3cdec] hover:shadow-[0_8px_22px_rgba(14,27,77,0.12)] hover:-translate-y-0.5 transition-all duration-200 flex flex-col">
      <div className="aspect-square p-3 bg-[#fafbfe] rounded-t-[10px] flex items-center justify-center">
        <img src={p.image} alt={p.title} width="184" height="184" loading="lazy" decoding="async" className="max-w-full max-h-full object-contain" />
      </div>
